...
export default class    Chat extends Plugin {
    ...
    sendMessage(args, user) {
        ...
        (async () => {
            ...
            wordWhitelist += ['conga','linger', 'stinger', 'hanger', 'challenger', 'finger', 'doppelganger', 'passenger', 'scavenger', 'endanger', 'endangered', 'danger', 'dangers', 'dangerous', 'messenger', 'outfits', 'outfit', 'stranger']
